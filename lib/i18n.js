...
(function (root) {
  const ZH = {
    ...
    'Paste a screenshot or text here, or ': '在此粘贴截图或文字，或',
    'upload a file': '上传文件',
    'Several deadlines found. Check the ones to add; edit each one below:': '发现多个时间点。请勾选需要添加的条目：',
    'Title': '标题',
    'Task name': '任务名称',
    'Date (optional)': '日期（可选）',
    'Date': '日期',
    ...
    'Enable free AI (one-time ~2 GB download, runs on your computer)': '启用免费 AI（需一次性下载，占用约 2 GB 空间，之后在你的电脑上运行）',
    "Chrome's built-in AI model. It runs entirely on your computer: no account, no API key, and nothing you analyze leaves your device. The model is shared by all of Chrome's AI features, so it only ever downloads once.": 'Chrome 内置的 AI 模型，完全在你的电脑上运行：不需要账号和 key，识别的内容不会离开设备。这个模型由 Chrome 的所有 AI 功能共用，只需下载一次。',
    ...
    "Chrome's built-in AI (free, runs on your computer)": 'Chrome 内置 AI（免费，在你的电脑上运行）',
    ...
    'AI source': 'AI 来源',
    'What is an API key?': 'API key 是什么？',
    "It's like a password from an AI company, such as Google, that lets Page2Task use their AI through your own account. Google Gemini has a free tier.":
      '它相当于 AI 公司（例如 Google）发给你的一串专属密码，让 Page2Task 能通过你自己的账号使用该公司的 AI。Google Gemini 有免费额度。',
    'Completely safe for you': '完全安全',
    ': ': '：',
    'Your key is stored only on your computer and is never shared with us or anyone else.': 'API key 仅存储于你的电脑，不会提供给包括开发者在内的任何第三方。',
    'Method 1 (recommended): choose "Your own API key" below. Google Gemini has a free tier; get a key at aistudio.google.com (no credit card needed).':
      '方法一（推荐）：在下方选择「自己的 API key」。Google Gemini 有免费额度，去 aistudio.google.com 领取（无需信用卡）。',
    "Method 2: enable Chrome's built-in AI with the button below. Basic quality; it downloads once (~2 GB) and runs on your computer.":
      '方法二：点下方按钮启用 Chrome 内置 AI。效果较弱，需一次性下载，占用约 2 GB 空间，之后在你的电脑上运行。',
    'Enable on-device AI (basic quality, one-time ~2 GB download)': '启用本地 AI（效果较弱，需一次性下载约 2 GB）',
    '30 free reads': '30 次免费识别',
    'No setup': '无需设置',
    'Works right away, no payment or card needed. After 30 reads, add your own key to keep going.': '装上就能用，无需付费或绑卡。30 次用完后，填入自己的 key 即可继续使用。',
    ...
    '30 free reads ({n} left)': '30 次免费识别（还剩 {n} 次）',
    'Free trial': '免费额度',
    'High quality': '高质量',
    'Basic quality': '效果较弱',
    'Used {n}/30.': '已用 {n}/30 次。',
    'Your 30 free reads are used up': '30 次免费识别已用完',
    ...
    '{n} free AI reads left': '剩余 {n} 次免费 AI 读取',
    ...
    'Is Page2Task working well for you?': 'Page2Task 用得还顺手吗？',
    'AI is finding the date…': 'AI 正在确认日期……',
    'Yes, leave a review': '挺好，去评价',
    'Not really, tell you why': '有问题，告诉你',
    ...
    'Free': '免费',
    'No key needed, runs on your computer. Weaker quality. One-time 2 GB download.': '无需 key，在你的电脑上运行。能力较弱。需一次性下载，占用约 2 GB 空间。',
    ...
    'Hide the steps': '收起步骤',
    'Uses Gemini Flash-Lite: fast, and free within the Gemini free tier.': '使用 Gemini Flash-Lite：速度快，在 Gemini 免费额度内不花钱。',
    ...
    'Copy the key it shows': '复制它给出的那串 key',
