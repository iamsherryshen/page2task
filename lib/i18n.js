...
(function (root) {
  const ZH = {
    ...
    "Method 1 (recommended, free): enable Chrome's built-in AI with the button below. It downloads once (~2 GB) and runs on your computer.": '方法一（推荐，免费）：点下方按钮启用 Chrome 内置 AI，需一次性下载，占用约 2 GB 空间，之后在你的电脑上运行。',
