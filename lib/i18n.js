...
(function (root) {
  const ZH = {
    ...
    'Better quality': '质量更好',
    'Use a key from Gemini, Claude, OpenAI, Kimi, or DeepSeek. Gemini has a free tier.': '使用 Gemini、Claude、OpenAI、Kimi 或 DeepSeek 的 key。Gemini 有免费额度。',
    'How to get one?': '怎么获取？',
    ...
    'Copy the key that starts with AIza': '复制以 AIza 开头的那串 key',
    ...
    'DeepSeek rate limit reached. Wait a minute and try again.': 'DeepSeek 触发限流。请等一分钟再试。',
    'Open platform.deepseek.com and sign in': '打开 platform.deepseek.com 并登录',
    'Top up your balance (DeepSeek has no free tier)': '充值余额（DeepSeek 没有免费额度）',
    'Go to API Keys and click "Create API key"': '进入 API Keys，点击「创建 API key」',
    'DeepSeek cannot read screenshots. Use another provider for images.': 'DeepSeek 无法识别截图。识别图片请换其他厂商。',
