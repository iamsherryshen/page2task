...
(function (root) {
  const ZH = {
    ...
    'This one used basic detection, which can be less accurate. From here you can:': '本次已改用基础识别，结果可能不够准确。之后你可以：',
    ...
    'Screenshots need AI. Add a key in Settings or switch to the on-device model.': '识别截图需要AI。请在设置页填入key，或改用本地模型。',
