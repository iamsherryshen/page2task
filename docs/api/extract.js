...
module.exports = async (req, res) => {
  ...
  const body = req.body || {};
  // Room for a whole PDF syllabus; ordinary page text arrives well under 6000.
  // Matches CLOUD_TEXT_CAP in lib/ai.js.
  const text = body.text ? String(body.text).slice(0, 24000) : null;
